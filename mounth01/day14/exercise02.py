...
class GraphicManager:
    ...
    @property
    def list_graohic(self):
        return self.__list_graphic

    def add_graohic(self,graphic):
...
manager.add_graohic(c01)
manager.add_graohic(r01)
# print(manager.list_graohic)
